...
LastEditTime: 2024-06-19 12:05:53
FilePath: /mengdizhang/LLM-LieDetector/bias-detection/data/TrustGPT/utils/dataset/load_dataset.py
...
class LoadDataset:
    ...
    def preprocess_social101_1(self, return_type='all', shuffle=False, size=None, seed=None):
        """
        Determine whether "./social-chem-101/" exists. Then preprocess the dataset.
        """
        if not os.path.exists("./social-chem-101/"):
